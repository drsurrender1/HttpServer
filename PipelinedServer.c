...
/*
httperf --server localhost --port 11116 --uri /test.html --max-connections=1500000000 --num-conns=15000 --http-version=1.1 --burst-length=5 --method=GET
httperf --server localhost --port 11116 --uri /test.html --max-connections=100 --num-conns=100 --http-version=1.1 --burst-length=5 --method=GET
httperf --server localhost --port 11106 --uri /test.html --max-connections=1500 --num-conns=105 --http-version=1.1 --burst-length=1 --method=GET
*/
...
void handle_request(char* request, int client_fd, const char *root_path){
    ...
    printf("flag_GET=%d\n", flag_GET);
    if ((flag_GET != 0)) {
        fprintf(stderr, "Method is not GETReturning\n");
